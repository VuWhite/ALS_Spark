...
class BenchmarkRunner:
    def __init__(self, spark_master: str, executor_memory: str = "1g"):
        ...
        self.executor_memory_mb = self._parse_memory(executor_memory)
...
def main():
    ...
    run_2node_only = len(sys.argv) > 1 and sys.argv[1] == "2"

    if run_2node_only:
        experiment_configs = [(2, 8)]
        print("\n*** Running 2-node experiment only ***")
    else:
        experiment_configs = [(1, 8), (2, 8), (5, 20)]
